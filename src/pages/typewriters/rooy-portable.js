  ...
  return (
   <Layout>
      <div className="container page-container">
        <h1>Rooy Portable Typewriters</h1>
...
<section className="brand-story">
  ...
  <div className="historical-text">
    ...
    It seems highly likely that the court decisions in Paris and New York led to Rooy adding the letters “MJ” to its branding, as well as to alternate brand names such as Roxy (though still with a defiant curve) and Mascotte.

    <p>I have not seen a <em>Mascotte</em> in the wild, but one with an AZERTY keyboard is pictured in the Robert Messenger blog post listed below in the Primary Sources.</p>
    ...
    <p className="source"><b>Davis, Will</b>. <em><a href="http://www.willdavis.org/Rooy1.html" target="_blank" rel="noopener noreferrer">the ROOY portable</a>.</em> An undated web page. Retrieved 25 Jan 2024. [It appears this page was originally illustrated with 11 photos; sadly it now only has placeholders for them.]</p>

    <p className="source"><b>Messenger, Robert</b>. <em><a href="https://oztypewriter.blogspot.com/2011/09/on-this-day-in-typewriter-history-cxiii.html" target="_blank" rel="noopener noreferrer">THE GENESIS OF THE ROOY: Where the crusading Joseph Louis Adhémar Borel found the Holy Grail of Typewriters</a>.</em> Blog post dated 13 Sep 2011. Retrieved 25 Jan 2024. [This is the best presentation on the design and production history of the Rooy portable that we have seen.]</p>
    ...
    <p className="source"><b>Polt, Richard.</b> <em>The Typewriter Revolution: A Typist's Companion for the 21st Century</em>. Woodstock, VT: The Countryman Press [2015]. Page 109, including a photo of a Rooy portable.</p>

    <p className="source"><b>TypewriterDatabase[dot]com</b>. <em><a href="https://typewriterdatabase.com/rooy.45.typewriter-serial-number-database" target="_blank" rel="noopener noreferrer">Rooy Typewriter Serial Numbers</a>.</em> Retrieved 25 Jan 2024.</p>

    <p className="source"><b>—</b>. <em><a href="https://typewriterdatabase.com/Rooy.portable.45.bmys" target="_blank" rel="noopener noreferrer">Rooy portable Typewriters by Year then Serial Number</a>.</em> Retrieved 25 Jan 2024. [Photo-illustrated galleries of typewriters of this model]</p>

    <p className="source"><b>—</b>. <em><a href="https://typewriterdatabase.com/Roxy.Portable.236.bmys" target="_blank" rel="noopener noreferrer">Roxy Portable Typewriters by Year then Serial Number</a>.</em> Retrieved 25 Jan 2024. [Photo-illustrated galleries of typewriters of this model]</p>
